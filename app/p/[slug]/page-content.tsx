      ...
      <div className="relative" style={{ zIndex: 10 }}>
          ...
          {data.cover_photo_url ? (
            <>
              ...
              <img
                ...
                alt="Foto de capa"
                className="relative z-10 w-full h-[60vh] object-contain"
              />
            </>
          ) : (
            <div
          ...
          <div className="absolute bottom-16 left-0 right-0 z-30 px-6 text-center">
            ...
            >
              ...
              <p className="text-sm text-white/80 tracking-wide font-light">
                Uma surpresa especial feita só para você
              </p>
            </motion.div>
          </div>
        ...
        {data.message && (
          <Section>
            <div className="relative py-10 px-8 text-center">
              ...
              <p className="relative z-10 text-xl md:text-2xl text-white/90 leading-relaxed font-serif italic text-balance">
                "{data.message}"
              </p>
        ...
        <footer className="py-16 text-center">
          ...
          <Link href="/" className="inline-block">
            <h3 className="font-serif text-2xl font-bold mb-6" style={{ background: `linear-gradient(90deg, ${PINK}, ${PURPLE})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              InfinityLove
            </h3>
          </Link>
          <div>
